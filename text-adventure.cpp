...
//Intro Story   
  std::cout << "It's been a strange day indeed. You've fallen down a ancient hole in Rancho De Las Pulgas now called Atherton, California, happened across a strange technology party from various silicon valley tech titans, and had many other absurd adventures.\n";
...
// Choice 1
  ...
  for (int i = 0; i < 3 && choice1 != 'A' && choice1 != 'B' && choice1 != 'C'; i++) {
    ...
    std::cout << "Enter B if you sneak a Silicon Valley Macbook in\n";
  ...
  switch (choice1) {
    case 'A':
      std::cout << "The Golden Bear explains that the jurors are writing down their names for fear they should forget before the end of the trial.\n";
      std::cout << "'How stupid!' you say in a loud voice, but you are cut off.\n";
      std::cout << "'SILENCE IN THE COURT!' shrieks the Golden Robot. His highness Don Ricardo puts on his glasses and looks around anxiously to see who was talking.\n";
      std::cout << "You manage to keep your mouth shut and King Ricardo fails to notice you.\n";
      break;
    ...
    std::cout << "You watch the Golden Robot fumble over the list. He reads at the the top of his shrill voice:\n";
    std::cout << "Donna Sophia!\n";
    std::cout << "\n";
    std::cout << "*      *      *\n";
    ...
    for (int i = 0; i < 3 && choice4 != 'A' && choice4 != 'B' && choice4 != 'C'; i++) {
        ...
        std::cout << "Enter B if you stay seated and shout 'Hola! Here!'.\n";
    ...
    if (choice4 != 'A' && choice4 != 'B' && choice4 != 'C') {
        ...
        std::cout << "'That's Sophia,' the Golden Bear points you out helpfully, even as you glare at him.\n";
    ...
    for (int i = 0; i < 3 && choice5 != 'A' && choice5 != 'B' && choice5 != 'C'; i++) {
        ...
        std::cout << "Enter C if you flip over the jury box again and steal a computer.\n";
        std::cin >> choice5;
    ...
    switch (choice5) {
        ...
        case 'B':
            std::cout << "'Hola, I'm not a mile high,' you say.\n";
            std::cout << "'Nearly TWO miles high,' says the Queen of California.\n";
        ...
        case 'C':
            ...
            std::cout << "You scoop up the remaining computer, which now appears to be very small, and shove it in your backpack.\n";
    ...
    std::cout << "'Wake up, Sophia dear!' your sister says. 'Why, what a long sleep you've had!'\n";
